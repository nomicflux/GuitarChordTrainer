...
(function(exports) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("guitar"), Halogen_HTML_Properties.ref(containerRef) ])([ Component_SVG.svg([ Component_SVG.height(height), Component_SVG.width(width), Component_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0 0", Data_Show.show(Data_Show.showInt)(width), Data_Show.show(Data_Show.showInt)(height + 1 | 0) ])), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(ClickFret.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedKeyFrets)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedOctaveFrets)(renderedStrings))) ]);
  };
