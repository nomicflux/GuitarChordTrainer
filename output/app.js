...
(function(exports) {
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeGuitar) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $65.currentGuitar = v1.value0;
                  $65.slot = v.value0;
                  $65.selectedNotes = Data_Set.empty;
                  return $65;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v3) {
                          ...
                          throw new Error("Failed pattern match at Component.App line 309, column 7 - line 315, column 20: " + [ v3.constructor.name ]);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 300, column 3 - line 315, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $76.currentChord = defaultOptionValue;
                  $76.filteredIntervals = emptyFilter;
                  return $76;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 328, column 7 - line 333, column 20: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 317, column 3 - line 333, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $90 = {};
                  for (var $91 in v2) {
                      if ({}.hasOwnProperty.call(v2, $91)) {
                          $90[$91] = v2[$91];
                      };
                  };
                  $90.currentNote = defaultOptionValue;
                  $90.filteredIntervals = emptyFilter;
                  return $90;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getNote))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          ...
                          $95.currentNote = v.value0;
                          $95.filteredIntervals = newFilter;
                          return $95;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 351, column 7 - line 356, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 335, column 3 - line 356, column 20: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $111 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($111) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $112.filteredIntervals = newFilter;
                  return $112;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 370, column 3 - line 375, column 25: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1.slot))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $127.selectedNotes = Data_Set.empty;
                      return $127;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $132.currentChord = defaultOptionValue;
                      $132.currentNote = defaultOptionValue;
                      $132.selectedNotes = emptyFilter;
                      $132.filteredIntervals = emptyFilter;
                      return $132;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $136.selectedNotes = v.value0.value0;
              return $136;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 297, column 1 - line 297, column 72: " + [ v.constructor.name ]);
  };
  ...
  var filteredNotes = function (currentChord) {
      return function (allowedNotes) {
          var $142 = Data_Set.isEmpty(allowedNotes);
          if ($142) {
  ...
  var filteredChords = function (allowedNotes) {
      var $143 = Data_Set.isEmpty(allowedNotes);
      if ($143) {
  ...
  var render = function (state) {
      ...
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $146 = isFiltered(state)(Chord.getNote(interval));
              if ($146) {
                  return "filtered";
              };
              return "unfiltered";
                  ...
                  return function (value) {
                      return function (query) {
                          ...
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("gct-select-div") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](label) ])([ Halogen_HTML_Core.text(label + ": ") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.name(label), Halogen_HTML_Properties.value((function () {
                              var $147 = Data_Set.member(Data_Ord.ordString)(value)(enabled);
                              if ($147) {
                                  return value;
                              };
      ...
      var renderSidebarContent = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("sidebar-content " + (function () {
          ...
          return "sidebar-hidden";
      })()) ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderSelects, renderButtons ])(Data_Maybe.maybe([  ])(function ($152) {
          return Data_Array.singleton(renderIntervalChart(Chord.chordToIntervals($152)));
      })(getChord(state)))) ]);
