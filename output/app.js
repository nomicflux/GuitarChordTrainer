...
(function(exports) {exports.getScrollTop = function () {
      ...
      return function (fret) {
          return function (radius) {
              return function (offset) {
                  return Component_SVG.circle([ Component_SVG.fill("grey"), Component_SVG.stroke("grey"), Component_SVG.r(radius), Component_SVG.cx(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(numStrings * Component_Constants.fretWidth | 0)(2) + offset | 0), Component_SVG.cy(Component_Constants.lineHeight(fret) - Component_Constants.halfFretHeight | 0) ]);
              };
          };
      };
  };
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof ClickFret) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(containerRef))(function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Scroll.getScrollTop))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Scroll.getScrollLeft))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                              var v4 = Web_HTML_HTMLElement.getBoundingClientRect(v1.value0)();
                              return v4.left;
                          }))(function (v4) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                                  var v5 = Web_HTML_HTMLElement.getBoundingClientRect(v1.value0)();
                                  return v5.top;
                              }))(function (v5) {
                                  var y = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(v.value0)) - v5 - v2;
                                  var x = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(v.value0)) - v4 - v3;
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(string))(Halogen_Query.request(Component_GuitarString.ToggleFret.create(fret))))(function (v6) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v7) {
                                          var notes = function (acc) {
                                              return function (id) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.GetNotes.create)))(function (v8) {
                                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Set.union(Note.ordNote)(acc)(Data_Maybe.fromMaybe(Data_Set.empty)(v8)));
                                                  });
                                              };
                                          };
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(notes)(Data_Set.empty)(v7))(function (v8) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Selected(v8)))(function () {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                              });
                                          });
                                      });
              ...
              throw new Error("Failed pattern match at Component.Guitar line 145, column 42 - line 168, column 18: " + [ v1.constructor.name ]);
          }))(function () {
      ...
      throw new Error("Failed pattern match at Component.Guitar line 131, column 8 - line 195, column 10: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      var numStrings = Data_Array.length(state.guitar.strings);
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(containerRef) ])([ Component_SVG.svg([ Component_SVG.height(height), Component_SVG.width(width), Component_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0 0", Data_Show.show(Data_Show.showInt)(width), Data_Show.show(Data_Show.showInt)(height + 1 | 0) ])), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(ClickFret.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedKeyFrets)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedOctaveFrets)(renderedStrings))) ]);
  };
...
(function(exports) {
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeGuitar) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $74.currentGuitar = v1.value0;
                  $74.slot = v.value0;
                  $74.selectedNotes = Data_Set.empty;
                  return $74;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v3) {
                          ...
                          throw new Error("Failed pattern match at Component.App line 280, column 9 - line 286, column 22: " + [ v3.constructor.name ]);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 271, column 5 - line 286, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $85.currentChord = defaultOptionValue;
                  $85.filteredIntervals = emptyFilter;
                  return $85;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $88.currentChord = v.value0;
                  $88.filteredIntervals = emptyFilter;
                  return $88;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 299, column 9 - line 304, column 22: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 288, column 5 - line 304, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $99.currentNote = defaultOptionValue;
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getNote))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          ...
                          $104.currentNote = v.value0;
                          $104.filteredIntervals = newFilter;
                          return $104;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 322, column 9 - line 327, column 22: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 306, column 5 - line 327, column 22: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $121 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($121) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 342, column 5 - line 347, column 27: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v3) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          ...
                          $133.selectedNotes = Data_Set.empty;
                          return $133;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
      ...
      if (v instanceof ClearAll) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v3) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(initialState))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              var $139 = {};
                              for (var $140 in v4) {
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $143.selectedNotes = v.value0.value0;
              return $143;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 268, column 8 - line 365, column 10: " + [ v.constructor.name ]);
  };
  var allGenChords = (function () {
      var forNote = function (note) {
          ...
          return new Data_Tuple.Tuple(Tagged.getName(note), Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (c) {
              return Data_Tuple.Tuple.create(Tagged.getName(c))(Chord.generateChord(Tagged.getValue(c))(Tagged.getValue(note)));
          })(chords)));
      };
      var mapping = (function () {
          var notes = Data_List.fromFoldable(Data_Foldable.foldableArray)(Note.allNotes);
          return Data_Functor.map(Data_List_Types.functorList)(forNote)(notes);
      })();
  ...
  var isFit = function (note) {
      return function (chord) {
          return function (allowed) {
              var thisChord = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(note)(allGenChords))(Data_Map_Internal.lookup(Data_Ord.ordString)(chord));
  ...
  var filteredChords = function (currentNote) {
      return function (allowedNotes) {
          var $149 = Data_Set.isEmpty(allowedNotes);
          if ($149) {
          ...
          return Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(Data_List.filter(function (k) {
              return isFit(currentNote)(k)(allowedNotes);
          })(Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(chordMap))));
      };
  };
  var filteredIntervals = function (allowedNotes) {
      var $150 = Data_Set.isEmpty(allowedNotes);
      if ($150) {
          return Data_Map.keys(noteMap);
      };
      var allowedChords = function (n) {
          return Data_List.fromFoldable(Data_Set.foldableSet)(filteredChords(n)(allowedNotes));
      };
      var noteChords = function (n) {
          return Data_List.mapMaybe(function (c) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(n)(allGenChords))(Data_Map_Internal.lookup(Data_Ord.ordString)(c));
          })(allowedChords(n));
      };
      var hasChords = function (n) {
          return Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_List["null"])(noteChords(n));
      };
      var allNotes = Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(noteMap));
      return Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(Data_List.filter(hasChords)(Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(noteMap))));
  };
  var render = function (state) {
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $152 = isFiltered(state)(Chord.getNote(interval));
              if ($152) {
                  return "filtered";
              };
              return "unfiltered";
                  ...
                  return function (value) {
                      return function (query) {
                          ...
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("gct-select-div"), Halogen_HTML_Properties.ref(label) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](label) ])([ Halogen_HTML_Core.text(label + ": ") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.name(label), Halogen_HTML_Properties.value((function () {
                              var $153 = Data_Set.member(Data_Ord.ordString)(value)(enabled);
                              if ($153) {
                                  return value;
                              };
      ...
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1 pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-3") ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ mkSelect(tuningRefName)(guitarMap)(Data_Map.keys(guitarMap))(state.slot)(ChangeGuitar.create), mkSelect(noteRefName)(noteMap)(filteredIntervals(state.selectedNotes))(state.currentNote)(ChangeNote.create), mkSelect(chordRefName)(chordMap)(filteredChords(state.currentNote)(state.selectedNotes))(state.currentChord)(ChangeChord.create), mkButton((function () {
          if (state.showColor) {
              return "Hide";
          };
          return "Show";
