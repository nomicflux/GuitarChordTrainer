...
})(PS["Component.Constants"] = PS["Component.Constants"] || {});
(function(exports) {
    "use strict";
...
})(PS["Component.Cookie"] = PS["Component.Cookie"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
    "use strict";
  var $foreign = PS["Component.Cookie"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var Data_Function_Uncurried = PS["Data.Function.Uncurried"];
  var Data_Functor = PS["Data.Functor"];
  var Data_Maybe = PS["Data.Maybe"];
...
(function(exports) {
  ...
  exports["icon"] = icon;
})(PS["Component.FontAwesome"] = PS["Component.FontAwesome"] || {});
(function(exports) {
    "use strict";
  var Color = PS["Color"];
  var Data_Eq = PS["Data.Eq"];
...
})(PS["Component.FretColor"] = PS["Component.FretColor"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  exports["fill"] = fill;
  exports["class_"] = class_;
})(PS["Component.SVG"] = PS["Component.SVG"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Interval = PS["Interval"];
...
(function(exports) {
  ...
  "use strict";
  var Chord = PS["Chord"];
  var Component_Constants = PS["Component.Constants"];
  var Component_FretColor = PS["Component.FretColor"];
  var Component_SVG = PS["Component.SVG"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Data_Array = PS["Data.Array"];
  ...
  var renderRightFret = function (x) {
      return function (fret) {
          return Component_SVG.line([ Component_SVG.x1(Component_Constants.halfFretWidth + x | 0), Component_SVG.x2((Component_Constants.halfFretWidth * 2 | 0) + x | 0), Component_SVG.y1(Component_Constants.lineHeight(fret)), Component_SVG.y2(Component_Constants.lineHeight(fret)), Component_SVG.stroke("black"), Component_SVG.class_("fret") ]);
      };
  };
  var renderLeftFret = function (x) {
      return function (fret) {
          return Component_SVG.line([ Component_SVG.x1(x), Component_SVG.x2(Component_Constants.halfFretWidth + x | 0), Component_SVG.y1(Component_Constants.lineHeight(fret)), Component_SVG.y2(Component_Constants.lineHeight(fret)), Component_SVG.stroke("black"), Component_SVG.class_("fret") ]);
      };
  };
  ...
  var render = function (state) {
      var renderToggledFret = function (fretPosition) {
          return Component_SVG.circle([ Component_SVG.cx(Component_Constants.halfFretWidth + state.x | 0), Component_SVG.cy(Component_Constants.lineHeight(fretPosition) - Component_Constants.halfFretHeight | 0), Component_SVG.r(Component_Constants.pushedFretRadius), Component_SVG.class_("toggled-fret") ]);
      };
      var renderPushedFret = function (v) {
          var color = (function () {
              if (state.showColor) {
                  return Component_FretColor.fretColor;
              };
              return fretColorLess;
          })();
          return Component_SVG.circle([ Component_SVG.cx(Component_Constants.halfFretWidth + state.x | 0), Component_SVG.cy(Component_Constants.lineHeight(v.value0.fret) - Component_Constants.halfFretHeight | 0), Component_SVG.r(Component_Constants.pushedFretRadius), Component_SVG.fill(Data_Maybe.maybe("black")(color)(v.value0.fromRoot)), Component_SVG.class_("pushed-fret") ]);
      };
      var renderString = function (frets) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.cons(Component_SVG.line([ Component_SVG.x1(Component_Constants.halfFretWidth + state.x | 0), Component_SVG.y1(Component_Constants.lineHeight(0)), Component_SVG.x2(Component_Constants.halfFretWidth + state.x | 0), Component_SVG.y2(Component_Constants.lineHeight(state.numFrets)), Component_SVG.stroke("black"), Component_SVG.class_("string") ]))(Data_Functor.map(Data_Functor.functorArray)(renderPushedFret)(Data_Array.fromFoldable(Data_Set.foldableSet)(frets))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(renderToggledFret)(Data_Array.fromFoldable(Data_Set.foldableSet)(state.toggled)))(Data_Array.concatMap(renderFret(state.x)(state.onLeft)(state.onRight))(Data_Array.range(0)(state.numFrets + 1 | 0))));
      };
      return Component_SVG.svg([  ])(renderString(state.frets));
  };
...
})(PS["Component.Helpers"] = PS["Component.Helpers"] || {});
(function(exports) {
...
})(PS["Component.Scroll"] = PS["Component.Scroll"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var $foreign = PS["Component.Scroll"];
  var Effect = PS["Effect"];
  var Web_HTML_HTMLElement = PS["Web.HTML.HTMLElement"];
...
(function(exports) {
  ...
  var Component_Helpers = PS["Component.Helpers"];
  var Component_SVG = PS["Component.SVG"];
  var Component_Scroll = PS["Component.Scroll"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Data_Array = PS["Data.Array"];
  var Data_Eq = PS["Data.Eq"];
          ...
          return function (id) {
              return function (string) {
                  var stringInput = {
                      string: string,
                      numFrets: numFrets,
                      x: id * Component_Constants.fretWidth | 0,
                      onLeft: id !== 0,
      ...
      return function (fret) {
          return function (radius) {
              return function (offset) {
                  return Component_SVG.circle([ Component_SVG.r(radius), Component_SVG.class_("fret-circle"), Component_SVG.cx(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(numStrings * Component_Constants.fretWidth | 0)(2) + offset | 0), Component_SVG.cy(Component_Constants.lineHeight(fret) - Component_Constants.halfFretHeight | 0) ]);
              };
          };
      };
  };
  var renderKeyFret = function (numStrings) {
      return function (fret) {
          return renderFretCircle(numStrings)(fret)(Component_Constants.fretMarkerRadius)(0);
      };
  };
  var renderOctaveFret = function (numStrings) {
      return function (fret) {
          var spacing = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(Component_Constants.fretMarkerRadius * 3 | 0)(2);
          return [ renderFretCircle(numStrings)(fret)(Component_Constants.fretMarkerRadius)(-spacing | 0), renderFretCircle(numStrings)(fret)(Component_Constants.fretMarkerRadius)(spacing) ];
      };
  };
  ...
  var $$eval = function (v) {
      if (v instanceof ShowChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.ResetChord.create))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.PushChord.create(v.value0)))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
              });
          });
      };
      if (v instanceof ShowColor) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.ShowColor.create(v.value0)))(function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
          });
      };
      if (v instanceof ClickFret) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(containerRef))(function (v1) {
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              };
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Scroll.getOffset(v1.value0)))(function (v2) {
                      ...
                      var string = Data_Int.round(x / Data_Int.toNumber(Component_Constants.fretWidth) - 0.5);
                      var fret = Data_Int.round(y / Data_Int.toNumber(Component_Constants.fretHeight) - 0.5);
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(string))(Halogen_Query.request(Component_GuitarString.ToggleFret.create(fret))))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.getBack(eqSlot)(function (acc) {
              ...
              throw new Error("Failed pattern match at Component.Guitar line 133, column 40 - line 145, column 16: " + [ v1.constructor.name ]);
          });
      };
      ...
      if (v instanceof ClearToggled) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.ResetToggled.create))(function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
          });
      };
      if (v instanceof ClearAll) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.ResetChord.create))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Helpers.passAlong(eqSlot)(Component_GuitarString.ResetToggled.create))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
              });
          });
      };
  ...
  var render = function (state) {
      ...
      var width = numStrings * Component_Constants.fretWidth | 0;
      var height = Component_Constants.stringLength(state.numFrets) + 1 | 0;
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(containerRef), Halogen_HTML_Properties.class_("guitar") ])([ Component_SVG.svg([ Component_SVG.height(height), Component_SVG.width(width), Component_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0 0", Data_Show.show(Data_Show.showInt)(width), Data_Show.show(Data_Show.showInt)(height + 1 | 0) ])), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(ClickFret.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedKeyFrets)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedOctaveFrets)(renderedStrings))) ]);
  };
...
(function(exports) {
  ...
  var Chord = PS["Chord"];
  var Component_Constants = PS["Component.Constants"];
  var Component_Cookie = PS["Component.Cookie"];
  var Component_FontAwesome = PS["Component.FontAwesome"];
  var Component_FretColor = PS["Component.FretColor"];
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeGuitar) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Cookie.setCookie(Component_Constants.guitarCookie)(v.value0)))(function (v2) {
  ...
  var render = function (state) {
      ...
      })()) ])([ Component_FontAwesome.icon("ellipsis-h") ]);
      var renderInterval = function (interval) {
          var halfWidth = Component_Constants.pushedFretRadius + 1 | 0;
          var halfHeight = Component_Constants.pushedFretRadius + 1 | 0;
      ...
      var mkButton = function (screenText) {
          return function (phoneIcon) {
              return function (class_) {
                  return function (query) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button-div") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("pure-button color-button button-" + class_), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(query)), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("button-icon") ])([ Component_FontAwesome.icon(phoneIcon) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("screen-only") ])([ Halogen_HTML_Core.text(" " + screenText) ]) ]) ]);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Component_Cookie.getCookie(Component_Constants.guitarCookie)))(function (v1) {
