  ...
  var $$eval = function (v) {
      ...
      if (v instanceof ClickFret) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(containerRef))(function (v1) {
              ...
              throw new Error("Failed pattern match at Component.Guitar line 140, column 42 - line 158, column 18: " + [ v1.constructor.name ]);
          }))(function () {
      ...
      throw new Error("Failed pattern match at Component.Guitar line 126, column 8 - line 180, column 10: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      var numStrings = Data_Array.length(state.guitar.strings);
...
(function(exports) {
  ...
  var $$eval = function (v) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $110 = {};
                      for (var $111 in v3) {
                          if ({}.hasOwnProperty.call(v3, $111)) {
                              $110[$111] = v3[$111];
                          };
                      };
                      $110.showColor = nowShow;
                      return $110;
                  }))(function () {
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $131.selectedNotes = v.value0.value0;
              return $131;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
  ...
  var filteredChords = function (currentNote) {
      return function (allowedNotes) {
          var $137 = Data_Set.isEmpty(allowedNotes);
          if ($137) {
              return chordMap;
          };
          return Data_Map_Internal.filterKeys(Data_Ord.ordString)(function (k) {
  ...
  var filteredNotes = function (allowedNotes) {
      ...
      var allowedChords = function (n) {
          return Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(filteredChords(n)(allowedNotes)));
      };
      ...
      return Data_Map_Internal.filterKeys(Data_Ord.ordString)(hasChords)(noteMap);
  };
  var render = function (state) {
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $140 = isFiltered(state)(Chord.getNote(interval));
              if ($140) {
                  return "filtered";
              };
              return "unfiltered";
