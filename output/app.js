...
(function(exports) {
  ...
  var allGuitars = [ new Tagged.Tagged("Standard Tuning", standardGuitar), new Tagged.Tagged("Drop D Tuning", dropD), new Tagged.Tagged("Open G Tuning", openG), new Tagged.Tagged("Standard 7 String", standard7String), new Tagged.Tagged("Standard 8 String", standard8String), new Tagged.Tagged("Mandolin", mandolin), new Tagged.Tagged("Ukulele", ukulele), new Tagged.Tagged("Standard 5 String Banjo", standard5StringBanjo), new Tagged.Tagged("Standerd 4 String Bass", bass), new Tagged.Tagged("Standerd 5 String Bass", bass) ];
