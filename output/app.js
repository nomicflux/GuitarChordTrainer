...
(function(exports) {
  ...
  var generateChordHelper = function (v) {
      return function (note) {
          ...
          throw new Error("Failed pattern match at Chord line 109, column 1 - line 109, column 50: " + [ v.constructor.name, note.constructor.name ]);
      };
  };
  ...
  var filterNotes = function (chord) {
      return function (notes) {
          return {
              rootNote: chord.rootNote,
              chord: Data_Set.difference(Note.ordNote)(chord.chord)(notes)
          };
      };
  };
  ...
  var chordToIntervals = function (chord) {
      return Data_Set.map(ordIntervalledNote)(function ($34) {
          return Data_Tuple.uncurry(mkIntervalledNote)(Data_Profunctor_Strong.fanout(Control_Category.categoryFn)(Data_Profunctor_Strong.strongFn)(Note.noteDistance(chord.rootNote))(Control_Category.identity(Control_Category.categoryFn))($34));
      })(chord.chord);
  };
  ...
  exports["chordToIntervals"] = chordToIntervals;
...
(function(exports) {
  ...
  var PushChord = (function () {
      function PushChord(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PushChord.create = function (value0) {
          return function (value1) {
              return new PushChord(value0, value1);
          };
      };
      return PushChord;
  })();
  ...
  var ResetChord = (function () {
      function ResetChord(value0) {
          this.value0 = value0;
      };
      ResetChord.create = function (value0) {
          return new ResetChord(value0);
      };
      return ResetChord;
  })();
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof PushChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var newFrets = Data_Set.fromFoldable(Data_List_Types.foldableList)(ordFrettedNote)(Data_List.concatMap(getNotePositions(v1.string)(v.value0.rootNote))(Data_List.fromFoldable(Data_Set.foldableSet)(v.value0.chord)));
  ...
  exports["PushChord"] = PushChord;
  exports["ShowColor"] = ShowColor;
  exports["GetNotes"] = GetNotes;
  exports["ResetChord"] = ResetChord;
...
(function(exports) {
  ...
  var ShowChord = (function () {
      function ShowChord(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ShowChord.create = function (value0) {
          return function (value1) {
              return new ShowChord(value0, value1);
          };
      };
      return ShowChord;
  })();
  ...
  var ClearChord = (function () {
      function ClearChord(value0) {
          this.value0 = value0;
      };
      ClearChord.create = function (value0) {
          return new ClearChord(value0);
      };
      return ClearChord;
  })();
  ...
  var $$eval = function (v) {
      if (v instanceof ShowChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Common_Communication.passAlong(eqSlot)(Component_GuitarString.ResetChord.create))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Common_Communication.passAlong(eqSlot)(Component_GuitarString.PushChord.create(v.value0)))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
              });
          });
      };
  ...
  exports["ShowChord"] = ShowChord;
  exports["ShowColor"] = ShowColor;
  exports["ClickFret"] = ClickFret;
  exports["ClearChord"] = ClearChord;
...
(function(exports) {
  ...
  var initialState = function (input) {
      ...
      return {
          ...
          showSidebar: false,
          scalesOrChords: Data_Maybe.fromMaybe(Scales.value)(Control_Bind.bind(Data_Maybe.bindMaybe)(input.scalesOrChords)(scaleChordFromString))
      };
  };
  var chordRefName = "Chord";
  var chordMap = Tagged.taggedToMap(Chord.allChords);
  var allGenChords = (function () {
      var forChord = function (chord) {
          var notes = Data_List.fromFoldable(Data_Foldable.foldableArray)(Note.allNotes);
          return new Data_Tuple.Tuple(Tagged.getName(chord), Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (n) {
              return Data_Tuple.Tuple.create(Tagged.getName(n))(Chord.generateChord(Tagged.getValue(chord))(Tagged.getValue(n)));
          })(notes)));
      };
      var mapping = (function () {
          var chords = Data_List.fromFoldable(Data_Foldable.foldableArray)(Chord.allChords);
          return Data_Functor.map(Data_List_Types.functorList)(forChord)(chords);
      })();
  ...
  var $$eval = function (v) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              if (v4 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ShowChord.create(v4.value0))))(function (v5) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 330, column 7 - line 336, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 321, column 3 - line 336, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $79.currentChord = defaultOptionValue;
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      if (v2 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v3))(Halogen_Query.request(Component_Guitar.ShowChord.create(v2.value0))))(function (v4) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Component.App line 349, column 7 - line 354, column 20: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 338, column 3 - line 354, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $93.currentNote = defaultOptionValue;
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              if (v4 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v5))(Halogen_Query.request(Component_Guitar.ShowChord.create(v4.value0))))(function (v6) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                      });
                                  });
                              };
                              throw new Error("Failed pattern match at Component.App line 372, column 7 - line 377, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 356, column 3 - line 377, column 20: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $114 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($114) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $115.filteredIntervals = newFilter;
                  return $115;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 391, column 3 - line 396, column 25: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1.currentGuitar))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $130 = {};
                      for (var $131 in v3) {
                          if ({}.hasOwnProperty.call(v3, $131)) {
                              $130[$131] = v3[$131];
                          };
                      };
                      $130.selectedNotes = Data_Set.empty;
                      return $130;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $135.currentChord = defaultOptionValue;
                      $135.currentNote = defaultOptionValue;
                      $135.selectedNotes = emptyFilter;
                      $135.filteredIntervals = emptyFilter;
                      return $135;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $139.selectedNotes = v.value0.value0;
              return $139;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 318, column 1 - line 318, column 64: " + [ v.constructor.name ]);
  };
  var isFit = function (note) {
      return function (chord) {
          return function (allowed) {
              var thisChord = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(chord)(allGenChords))(Data_Map_Internal.lookup(Data_Ord.ordString)(note));
              return Data_Maybe.maybe(false)(function (c) {
                  return Data_Eq.eq(Data_Set.eqSet(Note.eqNote))(Data_Set.intersection(Note.ordNote)(allowed)(c.chord))(allowed);
              })(thisChord);
          };
      };
  };
  var filteredNotes = function (currentChord) {
      return function (allowedNotes) {
          var $145 = Data_Set.isEmpty(allowedNotes);
          if ($145) {
          ...
          return Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(Data_List.filter(function (k) {
              return isFit(k)(currentChord)(allowedNotes);
          })(Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(noteMap))));
      };
  };
  var filteredChords = function (allowedNotes) {
      var $146 = Data_Set.isEmpty(allowedNotes);
      if ($146) {
          return Data_Map.keys(chordMap);
      };
      var theseNotes = function (c) {
          return Data_List.fromFoldable(Data_Set.foldableSet)(filteredNotes(c)(allowedNotes));
      };
      var chordNotes = function (c) {
          return Data_List.mapMaybe(function (n) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(c)(allGenChords))(Data_Map_Internal.lookup(Data_Ord.ordString)(n));
          })(theseNotes(c));
      };
      var hasNotes = function (n) {
          return Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_List["null"])(chordNotes(n));
      };
      var allNotes = Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(noteMap));
      return Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordString)(Data_List.filter(hasNotes)(Data_List.fromFoldable(Data_Set.foldableSet)(Data_Map.keys(chordMap))));
  };
  var render = function (state) {
      ...
      var renderInterval = function (interval) {
          ...
          var f = function (i) {
              var $148 = filterInterval(i);
              if ($148) {
                  return Component_Common_FretColor.fretColor(Chord.getInterval(i));
              };
              return "black";
          };
          var class_ = (function () {
              var $149 = isFiltered(state)(Chord.getNote(interval));
              if ($149) {
                  return "filtered";
              };
              return "unfiltered";
          })();
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("pure-menu-item restricted-height interval-key " + class_), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleInterval.create(Chord.getNote(interval)))) ])([ Component_Common_SVG.svg([ Component_Common_SVG.width(halfWidth * 2 | 0), Component_Common_SVG.height(halfHeight * 2 | 0), Component_Common_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0 0", Data_Show.show(Data_Show.showInt)(halfWidth * 2 | 0), Data_Show.show(Data_Show.showInt)(halfHeight * 2 | 0) ])) ])([ Component_Common_SVG.circle([ Component_Common_SVG.r(Component_Common_Constants.pushedFretRadius), Component_Common_SVG.cx(halfWidth), Component_Common_SVG.cy(halfHeight), Component_Common_SVG.fill(f(interval)), Component_Common_SVG.stroke("black") ]) ]), Halogen_HTML_Core.text(" = " + Interval.intervalToName(Chord.getInterval(interval))) ]);
      };
                  ...
                  return function (value) {
                      return function (query) {
                          ...
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("gct-select-div") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](label) ])([ Halogen_HTML_Core.text(label + ": ") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.name(label), Halogen_HTML_Properties.value((function () {
                              var $150 = Data_Set.member(Data_Ord.ordString)(value)(enabled);
                              if ($150) {
                                  return value;
                              };
      ...
      var renderSelects = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("select-div") ])([ mkSelect(tuningRefName)(guitarMap)(Data_Map.keys(guitarMap))(state.currentGuitar)(ChangeGuitar.create), mkSelect(chordRefName)(chordMap)(filteredChords(state.selectedNotes))(state.currentChord)(ChangeChord.create), mkSelect(noteRefName)(noteMap)(filteredNotes(state.currentChord)(state.selectedNotes))(state.currentNote)(ChangeNote.create) ]);
      ...
      var renderButtons = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button-div") ])([ mkButton((function () {
          if (state.showColor) {
              return "Hide";
          };
          return "Show";
      })() + " Interval Colors")((function () {
          if (state.showColor) {
              return "toggle-on";
          };
          return "toggle-off";
      })())("plain")(ToggleShowColor.create), mkButton("Clear Selected Frets")("eraser")("warning")(ClearSelected.create), mkButton("Clear All")("undo")("error")(ClearAll.create) ]);
      var renderSidebarContent = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("sidebar-content " + (function () {
          if (state.showSidebar) {
              return "sidebar-shown";
          };
          return "sidebar-hidden";
      })()) ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderSelects, renderButtons ])(Data_Maybe.maybe([  ])(function ($155) {
