...
(function(exports) {
  ...
  var initialState = function (cookieGuitar) {
      var mcookie = Control_Bind.bind(Data_Maybe.bindMaybe)(cookieGuitar)(function (v) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(v)(guitarMap))(function (v1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Tagged.Tagged(v, v1));
          });
      });
      var mguitar = Control_Alt.alt(Data_Maybe.altMaybe)(mcookie)(Data_Array.index(Guitar.allGuitars)(0));
      return {
          currentGuitar: Data_Maybe.maybe(Guitar.standardGuitar)(Tagged.getValue)(mguitar),
          currentChord: defaultOptionValue,
          currentNote: defaultOptionValue,
          slot: Data_Maybe.maybe(defaultOptionValue)(Tagged.getName)(mguitar),
          showColor: true,
  ...
  var $$eval = function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_Cookie.setCookie(Component_Common_Constants.guitarCookie)(v.value0)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $70.currentGuitar = v1.value0;
                      $70.slot = v.value0;
                      $70.selectedNotes = Data_Set.empty;
                      return $70;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 317, column 7 - line 323, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 307, column 3 - line 323, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $81.currentChord = defaultOptionValue;
                  $81.filteredIntervals = emptyFilter;
                  return $81;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $84.currentChord = v.value0;
                  $84.filteredIntervals = emptyFilter;
                  return $84;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 336, column 7 - line 341, column 20: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 325, column 3 - line 341, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $95.currentNote = defaultOptionValue;
                  $95.filteredIntervals = emptyFilter;
                  return $95;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getNote))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          ...
                          $100.currentNote = v.value0;
                          $100.filteredIntervals = newFilter;
                          return $100;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              if (v4 instanceof Data_Maybe.Nothing) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 359, column 7 - line 364, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 343, column 3 - line 364, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ToggleShowColor) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $111.showColor = nowShow;
                  return $111;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1.slot))(Halogen_Query.request(Component_Guitar.ShowColor.create(nowShow))))(function (v2) {
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $116 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($116) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $117.filteredIntervals = newFilter;
                  return $117;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 378, column 3 - line 383, column 25: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
      ...
      if (v instanceof ClearSelected) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1.slot))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $132 = {};
                      for (var $133 in v3) {
                          if ({}.hasOwnProperty.call(v3, $133)) {
                              $132[$133] = v3[$133];
                          };
                      };
                      $132.selectedNotes = Data_Set.empty;
                      return $132;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $137 = {};
                      for (var $138 in v3) {
                          if ({}.hasOwnProperty.call(v3, $138)) {
                              $137[$138] = v3[$138];
                          };
                      };
                      $137.currentChord = defaultOptionValue;
                      $137.currentNote = defaultOptionValue;
                      $137.selectedNotes = emptyFilter;
                      $137.filteredIntervals = emptyFilter;
                      return $137;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $141.selectedNotes = v.value0.value0;
              return $141;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 304, column 1 - line 304, column 64: " + [ v.constructor.name ]);
  };
  ...
  var filteredNotes = function (currentChord) {
      return function (allowedNotes) {
          var $147 = Data_Set.isEmpty(allowedNotes);
          if ($147) {
  ...
  var filteredChords = function (allowedNotes) {
      var $148 = Data_Set.isEmpty(allowedNotes);
      if ($148) {
  ...
  var render = function (state) {
      ...
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $151 = isFiltered(state)(Chord.getNote(interval));
              if ($151) {
                  return "filtered";
              };
              return "unfiltered";
                  ...
                  return function (value) {
                      return function (query) {
                          ...
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("gct-select-div") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](label) ])([ Halogen_HTML_Core.text(label + ": ") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.name(label), Halogen_HTML_Properties.value((function () {
                              var $152 = Data_Set.member(Data_Ord.ordString)(value)(enabled);
                              if ($152) {
                                  return value;
                              };
      ...
      var renderSidebarContent = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("sidebar-content " + (function () {
          ...
          return "sidebar-hidden";
      })()) ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderSelects, renderButtons ])(Data_Maybe.maybe([  ])(function ($157) {
          return Data_Array.singleton(renderIntervalChart(Chord.chordToIntervals($157)));
      })(getChord(state)))) ]);
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Component_Common_Cookie.getCookie(Component_Common_Constants.guitarCookie)))(function (v1) {
          return Halogen_VDom_Driver.runUI(Component_App.component)(v1)(v);
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
