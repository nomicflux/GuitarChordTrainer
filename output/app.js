...
(function(exports) {
  ...
  var render = function (state) {
      var renderSidebarToggle = Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleSidebar.create)), Halogen_HTML_Properties.class_("phone-only " + (function () {
      ...
      var mkButton = function (screenText) {
          return function (phoneIcon) {
              return function (class_) {
                  return function (query) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("button-div") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("pure-button color-button button-" + class_), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(query)), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("phone-only") ])([ Component_FontAwesome.icon(phoneIcon) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("screen-only") ])([ Halogen_HTML_Core.text(screenText) ]) ]) ]);
                  };
              };
          };
      };
