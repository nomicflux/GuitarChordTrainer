...
(function(exports) {
  ...
  var generateChordHelper = function (v) {
      return function (note) {
          ...
          throw new Error("Failed pattern match at Chord line 110, column 1 - line 110, column 50: " + [ v.constructor.name, note.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var halfStringWidth = halfFretWidth;
  var fretMarkerRadius = 6;
  var fretHeight = function (fret) {
      return (fret + 1 | 0) * fretWidth | 0;
  };
  var stringLength = function (frets) {
      return fretHeight(frets);
  };
  ...
  exports["halfStringWidth"] = halfStringWidth;
...
(function(exports) {
  ...
  var r = function ($7) {
      return Halogen_HTML_Properties.attr("r")(Data_Show.show(Data_Show.showInt)($7));
  };
  var line = function (props) {
      return svgElement("line")(props)([  ]);
  };
  var height = function ($8) {
      return Halogen_HTML_Properties.attr("height")(Data_Show.show(Data_Show.showInt)($8));
  };
  var fill = Halogen_HTML_Properties.attr("fill");
  var cy = function ($9) {
      return Halogen_HTML_Properties.attr("cy")(Data_Show.show(Data_Show.showInt)($9));
  };
  var cx = function ($10) {
      return Halogen_HTML_Properties.attr("cx")(Data_Show.show(Data_Show.showInt)($10));
  };
...
(function(exports) {
  ...
  var Note = PS["Note"];
  var Prelude = PS["Prelude"];                 
  var PushFret = (function () {
      function PushFret(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PushFret.create = function (value0) {
          return function (value1) {
              return new PushFret(value0, value1);
          };
      };
      return PushFret;
  })();
  var ReleaseFret = (function () {
      function ReleaseFret(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ReleaseFret.create = function (value0) {
          return function (value1) {
              return new ReleaseFret(value0, value1);
          };
      };
      return ReleaseFret;
  })();
  ...
  var ReleaseChord = (function () {
      function ReleaseChord(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ReleaseChord.create = function (value0) {
          return function (value1) {
              return new ReleaseChord(value0, value1);
          };
      };
      return ReleaseChord;
  })();
  ...
  var renderRightFret = function (x) {
      return function (fret) {
          return Component_SVG.line([ Component_SVG.x1(Component_Constants.halfStringWidth + x | 0), Component_SVG.x2((Component_Constants.halfStringWidth * 2 | 0) + x | 0), Component_SVG.y1(Component_Constants.fretHeight(fret)), Component_SVG.y2(Component_Constants.fretHeight(fret)), Component_SVG.stroke("black"), Component_SVG.class_("fret") ]);
      };
  };
  var renderLeftFret = function (x) {
      return function (fret) {
          return Component_SVG.line([ Component_SVG.x1(x), Component_SVG.x2(Component_Constants.halfStringWidth + x | 0), Component_SVG.y1(Component_Constants.fretHeight(fret)), Component_SVG.y2(Component_Constants.fretHeight(fret)), Component_SVG.stroke("black"), Component_SVG.class_("fret") ]);
      };
  };
  ...
  var renderPushedFret = function (showColor) {
      return function (x) {
          return function (v) {
              var f = (function () {
                  if (showColor) {
              ...
              return Component_SVG.circle([ Component_SVG.cx(Component_Constants.halfStringWidth + x | 0), Component_SVG.cy(Component_Constants.fretHeight(v.value0.fret) - Component_Constants.halfFretWidth | 0), Component_SVG.r(Component_Constants.pushedFretRadius), Component_SVG.stroke("black"), Component_SVG.fill(Data_Maybe.maybe("black")(f)(v.value0.fromRoot)), Component_SVG.class_("pushed-fret") ]);
          };
      };
  };
  var render = function (state) {
      var renderString = function (frets) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.cons(Component_SVG.line([ Component_SVG.x1(Component_Constants.halfStringWidth + state.x | 0), Component_SVG.y1(Component_Constants.fretHeight(0)), Component_SVG.x2(Component_Constants.halfStringWidth + state.x | 0), Component_SVG.y2(Component_Constants.fretHeight(state.numFrets)), Component_SVG.stroke("black"), Component_SVG.class_("string") ]))(Data_Functor.map(Data_Functor.functorArray)(renderPushedFret(state.showColor)(state.x))(Data_Array.fromFoldable(Data_Set.foldableSet)(frets))))(Data_Array.concatMap(renderFret(state.x)(state.onLeft)(state.onRight))(Data_Array.range(0)(state.numFrets + 1 | 0)));
      };
  ...
  var $$eval = function (v) {
      if (v instanceof PushFret) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.frets;
          }))(function (v1) {
              var frettedNote = new FrettedNote({
                  fret: v.value0.position,
                  fromRoot: Data_Maybe.Nothing.value
              });
              var newFrets = Data_Set.insert(ordFrettedNote)(frettedNote)(v1);
      ...
      if (v instanceof ReleaseFret) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFrets = Data_Set["delete"](ordFrettedNote)(frettedNote)(v1);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $44 = {};
                  for (var $45 in v2) {
      ...
      if (v instanceof ReleaseChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var newFrets = Data_Set.fromFoldable(Data_List_Types.foldableList)(ordFrettedNote)(Data_List.concatMap(getNotePositions(v1.string)(v.value0.rootNote))(Data_List.fromFoldable(Data_Set.foldableSet)(v.value0.chord)));
              var forState = Data_Set.difference(ordFrettedNote)(v1.frets)(newFrets);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $56 = {};
                  for (var $57 in v2) {
      ...
      throw new Error("Failed pattern match at Component.GuitarString line 135, column 8 - line 172, column 17: " + [ v.constructor.name ]);
  };
  ...
  exports["PushFret"] = PushFret;
  exports["ReleaseFret"] = ReleaseFret;
  exports["PushChord"] = PushChord;
  exports["ReleaseChord"] = ReleaseChord;
  exports["ShowColor"] = ShowColor;
  exports["Reset"] = Reset;
  exports["component"] = component;
  exports["fretColorLess"] = fretColorLess;
  exports["renderPushedFret"] = renderPushedFret;
...
(function(exports) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div_([ Component_SVG.svg([ Component_SVG.height(height), Component_SVG.width(width), Component_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0 0", Data_Show.show(Data_Show.showInt)(width), Data_Show.show(Data_Show.showInt)(height + 1 | 0) ])) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedKeyFrets)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderedOctaveFrets)(renderedStrings))) ]);
  };
  ...
  var $$eval = function (v) {
      if (v instanceof ShowChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var reset = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.Reset.create));
                  };
              };
      ...
      throw new Error("Failed pattern match at Component.Guitar line 109, column 8 - line 123, column 10: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var HandleGuitar = (function () {
      function HandleGuitar(value0) {
          this.value0 = value0;
      };
      HandleGuitar.create = function (value0) {
          return new HandleGuitar(value0);
      };
      return HandleGuitar;
  })();
  ...
  var getChord = function (state) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(state.currentChord)(function (v) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(state.currentNote)(function (v1) {
  ...
  var initialState = (function () {
      ...
      return {
          ...
          currentChord: Data_Maybe.Nothing.value,
          currentNote: Data_Maybe.Nothing.value,
  ...
  var $$eval = function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 197, column 9 - line 203, column 22: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 190, column 5 - line 203, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $72.currentChord = Data_Maybe.Nothing.value;
                  $72.filteredNotes = emptyFilter;
                  return $72;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $75.currentChord = new Data_Maybe.Just(v1.value0);
                  $75.filteredNotes = emptyFilter;
                  return $75;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 216, column 9 - line 221, column 22: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 205, column 5 - line 221, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $86.currentNote = Data_Maybe.Nothing.value;
                  $86.filteredNotes = emptyFilter;
                  return $86;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          var $91 = {};
                          for (var $92 in v4) {
                              if ({}.hasOwnProperty.call(v4, $92)) {
                                  $91[$92] = v4[$92];
                              };
                          };
                          $91.currentNote = new Data_Maybe.Just(v1.value0);
                          $91.filteredNotes = newFilter;
                          return $91;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 239, column 9 - line 244, column 22: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 223, column 5 - line 244, column 22: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleNote) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $108 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($108) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 259, column 5 - line 264, column 27: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
      ...
      throw new Error("Failed pattern match at Component.App line 187, column 8 - line 266, column 10: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $120 = isFiltered(state)(Chord.getNote(interval));
              if ($120) {
                  return "filtered";
              };
              return "unfiltered";
          ...
          return function (items) {
              return function (value) {
                  return function (query) {
                      ...
                      })(value)))(Data_Array.cons(defaultOption)(Data_Functor.map(Data_Functor.functorArray)(mkOption)(keys))) ]);
                  };
              };
          };
      };
      ...
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1 pure-u-sm-1 pure-u-md-1-2 pure-u-lg-1-3") ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ mkSelect("Tuning")(guitarMap)(new Data_Maybe.Just(state.slot))(ChangeGuitar.create), mkSelect("Chord")(chordMap)(Data_Maybe.Nothing.value)(ChangeChord.create), mkSelect("Note")(noteMap)(Data_Maybe.Nothing.value)(ChangeNote.create), mkButton((function () {
          ...
          return "Show";
      })() + " Interval Colors")("plain")(ToggleShowColor.create) ])(Data_Maybe.maybe([  ])(function ($122) {
          return Data_Array.singleton(renderIntervalChart(Chord.chordToIntervals($122)));
      })(getChord(state)))) ]);
