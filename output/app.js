...
(function(exports) {
  ...
  var allGuitars = [ new Tagged.Tagged("Standard Tuning", standardGuitar), new Tagged.Tagged("Drop D Tuning", dropD), new Tagged.Tagged("Open G Tuning", openG), new Tagged.Tagged("All Fourths", allFourths), new Tagged.Tagged("7 String Guitar", standard7String), new Tagged.Tagged("8 String Guitar", standard8String), new Tagged.Tagged("Drop E 8 String", dropE8String), new Tagged.Tagged("Mandolin", mandolin), new Tagged.Tagged("Ukulele", ukulele), new Tagged.Tagged("Banjo", standard5StringBanjo), new Tagged.Tagged("Bass", bass), new Tagged.Tagged("5 String Bass", fiveStringBass) ];
