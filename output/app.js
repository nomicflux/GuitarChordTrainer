...
(function(exports) {
  ...
  var scaleChordToString = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App line 72, column 1 - line 72, column 38: " + [ v.constructor.name ]);
  };
  ...
  var getNote = function (state) {
      return Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentNote)(noteMap);
  };
  ...
  var filteredNotes = function (intervalMap) {
      return function (currentIntervals) {
          return function (allowedNotes) {
              var $74 = Data_Set.isEmpty(allowedNotes);
              if ($74) {
  ...
  var getScale = function (state) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentScale)(allGenScales))(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentNote));
  };
  ...
  var getChord = function (state) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentChord)(allGenChords))(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentNote));
  };
  ...
  var getFiltered = function (state) {
      ...
      throw new Error("Failed pattern match at Component.App line 113, column 3 - line 115, column 37: " + [ state.scalesOrChords.constructor.name ]);
  };
  var $$eval = function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_Cookie.setCookie(Component_Common_Constants.guitarCookie)(v.value0)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $87.currentGuitar = v.value0;
                      $87.selectedNotes = Data_Set.empty;
                      return $87;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFiltered))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 422, column 7 - line 428, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 413, column 3 - line 428, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $98.currentChord = v.value0;
                  $98.filteredIntervals = emptyFilter;
                  return $98;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 437, column 7 - line 442, column 20: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 430, column 3 - line 442, column 20: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeScale) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $109.currentScale = v.value0;
                  $109.filteredIntervals = emptyFilter;
                  return $109;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getScale))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 451, column 7 - line 456, column 20: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 444, column 3 - line 456, column 20: " + [ v1.constructor.name ]);
      };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getNote))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          var $122 = {};
                          for (var $123 in v4) {
                              if ({}.hasOwnProperty.call(v4, $123)) {
                                  $122[$123] = v4[$123];
                              };
                          };
                          $122.currentNote = v.value0;
                          $122.filteredIntervals = newFilter;
                          return $122;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFiltered))(function (v4) {
                              if (v4 instanceof Data_Maybe.Nothing) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 470, column 7 - line 475, column 20: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 458, column 3 - line 475, column 20: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $138 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($138) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFiltered))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 489, column 3 - line 494, column 16: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_Cookie.setCookie(Component_Common_Constants.scaleChordCookie)(scaleChordToString(newSC))))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFiltered))(function (v3) {
                          ...
                          throw new Error("Failed pattern match at Component.App line 505, column 3 - line 510, column 16: " + [ v3.constructor.name ]);
                      });
                  });
              });
          });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1.currentGuitar))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $163.selectedNotes = Data_Set.empty;
                      return $163;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $168.currentChord = defaultOptionValue;
                      $168.currentNote = defaultOptionValue;
                      $168.selectedNotes = emptyFilter;
                      $168.filteredIntervals = emptyFilter;
                      return $168;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $172.selectedNotes = v.value0.value0;
              return $172;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 410, column 1 - line 410, column 64: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      ...
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $180 = isFiltered(state)(Component_Common_RootedInterval.getNote(interval));
              if ($180) {
                  return "filtered";
              };
              return "unfiltered";
      ...
      var renderIntervalChart = function (intervals) {
          var scClass = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 317, column 19 - line 320, column 7: " + [ state.scalesOrChords.constructor.name ]);
          })();
                  ...
                  return function (value) {
                      return function (query) {
                          ...
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("gct-select-div") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](label) ])([ Halogen_HTML_Core.text(label + ": ") ]), Halogen_HTML_Elements.select([ Halogen_HTML_Properties.name(label), Halogen_HTML_Properties.value((function () {
                              var $182 = Data_Set.member(Data_Ord.ordString)(value)(enabled);
                              if ($182) {
                                  return value;
                              };
      ...
      var renderSelects = (function () {
          var noteSource = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 225, column 13 - line 227, column 43: " + [ state.scalesOrChords.constructor.name ]);
          })();
          var noteGetter = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 221, column 13 - line 223, column 37: " + [ state.scalesOrChords.constructor.name ]);
          })();
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("select-div") ])([ mkSelect(tuningRefName)(guitarMap)(Data_Map.keys(guitarMap))(state.currentGuitar)(ChangeGuitar.create), (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 231, column 10 - line 235, column 110: " + [ state.scalesOrChords.constructor.name ]);
          })(), mkSelect(noteRefName)(noteMap)(filteredNotes(noteGetter)(noteSource)(state.selectedNotes))(state.currentNote)(ChangeNote.create) ]);
      })();
      ...
      var renderButtons = (function () {
          var scaleChordText = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 245, column 11 - line 248, column 9: " + [ state.scalesOrChords.constructor.name ]);
          })();
          var scaleChordIcon = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 249, column 11 - line 252, column 7: " + [ state.scalesOrChords.constructor.name ]);
          })();
      ...
      var renderSidebarContent = (function () {
          var intervals = (function () {
              ...
              throw new Error("Failed pattern match at Component.App line 263, column 13 - line 265, column 39: " + [ state.scalesOrChords.constructor.name ]);
          })();
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("sidebar-content " + (function () {
              ...
              return "sidebar-hidden";
          })()) ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderSelects, renderButtons ])(Data_Maybe.maybe([  ])(function ($193) {
              return Data_Array.singleton(renderIntervalChart(Component_Common_RootedInterval.toIntervals($193)));
          })(intervals))) ]);
      })();
