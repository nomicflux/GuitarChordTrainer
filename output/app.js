...
(function(exports) {
  ...
  var ordFrettedNote = new Data_Ord.Ord(function () {
      ...
      return function (v1) {
          var $40 = v.value0.fret === v1.value0.fret;
          if ($40) {
  ...
  var $$eval = function (v) {
      if (v instanceof ToggleFret) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  var present = Data_Set.member(Data_Ord.ordInt)(v.value0)(v2);
                  var newToggled = (function () {
                      if (present) {
                          return Data_Set["delete"](Data_Ord.ordInt)(v.value0)(v2);
                      };
                      return Data_Set.insert(Data_Ord.ordInt)(v.value0)(v2);
                  })();
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $47 = {};
                      for (var $48 in v3) {
                          if ({}.hasOwnProperty.call(v3, $48)) {
                              $47[$48] = v3[$48];
                          };
                      };
                      $47.toggled = newToggled;
                      return $47;
                  }))(function () {
      ...
      if (v instanceof GetNotes) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  return v2.string.baseNote;
              }))(function (v2) {
                  var notes = Data_Set.map(Note.ordNote)(function (fret) {
                      return Note.incNoteBy(v2)(fret);
                  })(v1);
      ...
      throw new Error("Failed pattern match at Component.GuitarString line 154, column 8 - line 185, column 17: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var getSlotIds = function (state) {
      var numStrings = Data_Array.length(state.guitar.strings);
      return Data_Array.range(0)(numStrings - 1 | 0);
  };
  ...
  var $$eval = function (v) {
      if (v instanceof ShowChord) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var reset = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.ResetChord.create));
                  };
              };
              var pushNotes = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.PushChord.create(v.value0)));
                  };
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(reset)(Data_Maybe.Nothing.value)(v1))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(pushNotes)(Data_Maybe.Nothing.value)(v1))(function (v3) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
                  });
              });
          });
      ...
      if (v instanceof ShowColor) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var toggleColor = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.ShowColor.create(v.value0)));
                  };
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(toggleColor)(Data_Maybe.Nothing.value)(v1))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
              });
          });
      };
      if (v instanceof ClickFret) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(containerRef))(function (v1) {
              if (v1 instanceof Data_Maybe.Nothing) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Scroll.getOffset(v1.value0)))(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(string))(Halogen_Query.request(Component_GuitarString.ToggleFret.create(fret))))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v4) {
                              var notes = function (acc) {
                                  return function (id) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.GetNotes.create)))(function (v5) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Set.union(Note.ordNote)(acc)(Data_Maybe.fromMaybe(Data_Set.empty)(v5)));
                                      });
                                  };
                              };
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(notes)(Data_Set.empty)(v4))(function (v5) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Selected(v5)))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  });
                              });
                          });
              ...
              throw new Error("Failed pattern match at Component.Guitar line 143, column 42 - line 159, column 18: " + [ v1.constructor.name ]);
          }))(function () {
      ...
      if (v instanceof ClearToggled) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var reset = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.ResetToggled.create));
                  };
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(reset)(Data_Maybe.Nothing.value)(v1))(function (v2) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
      ...
      if (v instanceof ClearAll) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var resetToggled = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.ResetToggled.create));
                  };
              };
              var resetChord = function (v2) {
                  return function (id) {
                      return Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.ResetChord.create));
                  };
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(resetChord)(Data_Maybe.Nothing.value)(v1))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(resetToggled)(Data_Maybe.Nothing.value)(v1))(function (v3) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
                  });
              });
          });
      ...
      if (v instanceof GetNotes) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v1) {
              var notes = function (acc) {
                  return function (id) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.GetNotes.create)))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Set.union(Note.ordNote)(acc)(Data_Maybe.fromMaybe(Data_Set.empty)(v2)));
                      });
                  };
              };
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(notes)(Data_Set.empty)(v1))(function (v2) {
      ...
      throw new Error("Failed pattern match at Component.Guitar line 129, column 8 - line 186, column 10: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      var numStrings = Data_Array.length(state.guitar.strings);
...
(function(exports) {
  ...
  var initialState = (function () {
      var mguitar = Data_Array.index(Guitar.allGuitars)(0);
      return {
  ...
  var getChord = function (state) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentChord)(chordMap))(function (v) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(state.currentNote)(noteMap))(function (v1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Chord.generateChord(v)(v1));
          });
      });
  };
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeGuitar) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $75.currentGuitar = v1.value0;
                  $75.slot = v.value0;
                  $75.selectedNotes = Data_Set.empty;
                  return $75;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v3) {
                          if (v3 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          };
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ShowChord.create(v3.value0))))(function (v4) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v.value0))(Halogen_Query.request(Component_Guitar.ShowColor.create(v5))))(function (v6) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                      });
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at Component.App line 312, column 9 - line 318, column 22: " + [ v3.constructor.name ]);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 303, column 5 - line 318, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeChord) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $86.currentChord = defaultOptionValue;
                  $86.filteredIntervals = emptyFilter;
                  return $86;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $89.currentChord = v.value0;
                  $89.filteredIntervals = emptyFilter;
                  return $89;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 331, column 9 - line 336, column 22: " + [ v2.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 320, column 5 - line 336, column 22: " + [ v1.constructor.name ]);
      };
      if (v instanceof ChangeNote) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $100.currentNote = defaultOptionValue;
                  $100.filteredIntervals = emptyFilter;
                  return $100;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getNote))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          var $105 = {};
                          for (var $106 in v4) {
                              if ({}.hasOwnProperty.call(v4, $106)) {
                                  $105[$106] = v4[$106];
                              };
                          };
                          $105.currentNote = v.value0;
                          $105.filteredIntervals = newFilter;
                          return $105;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v4) {
                              ...
                              throw new Error("Failed pattern match at Component.App line 354, column 9 - line 359, column 22: " + [ v4.constructor.name ]);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Component.App line 338, column 5 - line 359, column 22: " + [ v1.constructor.name ]);
      };
      ...
      if (v instanceof ToggleInterval) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              var newFilter = (function () {
                  var $122 = Data_Set.member(Note.ordNote)(v.value0)(v1);
                  if ($122) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $123.filteredIntervals = newFilter;
                  return $123;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getFilteredChord))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Component.App line 374, column 5 - line 379, column 27: " + [ v2.constructor.name ]);
                  });
              });
          });
      };
      ...
      if (v instanceof ClearSelected) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  return v2.currentGuitar;
              }))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearToggled.create)))(function (v3) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                          var $139 = {};
                          for (var $140 in v4) {
                          ...
                          $139.selectedNotes = Data_Set.empty;
                          return $139;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(v1))(Halogen_Query.request(Component_Guitar.ClearAll.create)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $144 = {};
                      for (var $145 in v3) {
                          if ({}.hasOwnProperty.call(v3, $145)) {
                              $144[$145] = v3[$145];
                          };
                      };
                      $144.currentChord = defaultOptionValue;
                      $144.currentNote = defaultOptionValue;
                      $144.selectedNotes = emptyFilter;
                      $144.filteredIntervals = emptyFilter;
                      return $144;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      if (v instanceof HandleGuitar) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $148.selectedNotes = v.value0.value0;
              return $148;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          });
      };
      throw new Error("Failed pattern match at Component.App line 300, column 8 - line 401, column 10: " + [ v.constructor.name ]);
  };
  ...
  var filteredNotes = function (currentChord) {
      return function (allowedNotes) {
          var $154 = Data_Set.isEmpty(allowedNotes);
          if ($154) {
  ...
  var filteredChords = function (allowedNotes) {
      var $155 = Data_Set.isEmpty(allowedNotes);
      if ($155) {
  ...
  var render = function (state) {
      ...
      var renderInterval = function (interval) {
          ...
          var class_ = (function () {
              var $158 = isFiltered(state)(Chord.getNote(interval));
              if ($158) {
                  return "filtered";
              };
              return "unfiltered";
      ...
      var renderSidebarContent = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("sidebar-content " + (function () {
          ...
          return "sidebar-hidden";
      })()) ])([ Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderSelects, renderButtons ])(Data_Maybe.maybe([  ])(function ($164) {
          return Data_Array.singleton(renderIntervalChart(Chord.chordToIntervals($164)));
      })(getChord(state)))) ]);
