...
(function(exports) {exports.getScrollTop = function (unit) {
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof ClickFret) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(containerRef))(function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Scroll.getScrollTop))(function (v2) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                          var v3 = Web_HTML_HTMLElement.getBoundingClientRect(v1.value0)();
                          return v3.left;
                      }))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                              ...
                              var y = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageY(v.value0)) - v4 - v2;
                              var x = Data_Int.toNumber(Web_UIEvent_MouseEvent.pageX(v.value0)) - v3;
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(string))(Halogen_Query.request(Component_GuitarString.ToggleFret.create(fret))))(function (v5) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getSlotIds))(function (v6) {
                                      var notes = function (acc) {
                                          return function (id) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(id))(Halogen_Query.request(Component_GuitarString.GetNotes.create)))(function (v7) {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Set.union(Note.ordNote)(acc)(Data_Maybe.fromMaybe(Data_Set.empty)(v7)));
                                              });
                                          };
                                      };
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Array.foldM(Halogen_Query_HalogenM.monadHalogenM)(notes)(Data_Set.empty)(v6))(function (v7) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Selected(v7)))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          });
                                      });
                                  });
              ...
              throw new Error("Failed pattern match at Component.Guitar line 146, column 42 - line 168, column 18: " + [ v1.constructor.name ]);
          }))(function () {
      ...
      throw new Error("Failed pattern match at Component.Guitar line 132, column 8 - line 195, column 10: " + [ v.constructor.name ]);
  };
  var render = function (state) {
      var numStrings = Data_Array.length(state.guitar.strings);
